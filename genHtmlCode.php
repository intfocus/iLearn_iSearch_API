...
////////////////////////////////////////
//Dylan
//讀取樣板html,並將內容置換後的字串回傳
//
// #001 modified by Odie, 2013/09/11
//      Change the default name of the 8th type
///////////////////////////////////////
define(FILE_ERROR, -3);
define(N_OF_TOP, 10);
...
define(TEMPLATE_HTML, "reportDetail.html");

function genHtmlCode($report_name, $create_time, $customer_name, $range_begin, $range_end, $computer_numbers, $arr_identity_type,
      ...
      $person_extreme_detail, $person_high_detail,$arr_extreme_detail, $arr_high_detail, $type8_enable, $type8_name)       // #001
{
   $i;
   $tempLength = 0;
   ...
   $pattern = array("身分證" , "手機", "住址", "電子信箱", "信用卡", "姓名", "家用電話", "生日");
   $dataRiskCount = array(0=>$arr_sum_risk_count[0],1=>$arr_sum_risk_count[1],2=>$arr_sum_risk_count[2], 3=>$arr_sum_risk_count[3], 4=>$arr_sum_risk_count[4], 5=>$arr_sum_risk_count[5],6=>$arr_sum_risk_count[6],7=>$arr_sum_risk_count[7]);   
   $dataKinds = array();
   ...
   //開啟樣本檔案
   //////////////////////////////// 
   if(!@($file = file_get_contents(TEMPLATE_HTML)))
   {
      return FILE_ERROR;
   }
   /////////////////////////////////
