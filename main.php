                              ...
                              <tr>
                                 <td>
                                    <div class="listContent2">
                                       <div class="title"><strong style="font-size:13px;">歡迎使用 P-Marker Cloud 個資盤點服務<br>請輸入帳號密碼進行登入</strong></div>
                                    </div>
                                    <form name=myForm method=POST action=login.php>
                                       <div class="listContent">
                                          <div class="title">帳號 - Login Name :</div>
                                       ...
                                       <div class="listContent">
                                          <a href="<?php echo URL_PREFIX; ?>/password.html">忘記密碼</a>
                                       </div>
<?php
...
?>
                                       ...
                                       <div id="msg" class="msg" style="display:none;">錯誤 -- 輸入帳號或密碼錯誤，請重新輸入</div>         
                                       </a>
                                    </form>
                                 </td>
                              </tr>
