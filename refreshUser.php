...
// refreshUser.php
//   return string of the refreshed user table
//   (called after the department is edited, the user table needs to be refreshed again)
///////////////////////////////////////////////////
   ...
   {
      if(strcmp($check_str, "refresh_user"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
