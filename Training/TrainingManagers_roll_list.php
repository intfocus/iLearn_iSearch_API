<?php
   require_once("TrainingManagers_utility.php");
   ...
   if (($training_id = check_number($_GET["TrainingId"])) == SYMBOL_ERROR)
   {
      sleep(DELAY_SEC);
      echo SYMBOL_ERROR;
      return;
...
function modifyUsersContent(training_id)
{
   ...
   url_str = "TrainingManagers_update_roll.php";
   $.ajax
   ({
      beforeSend: function()
      {
   ...
   <table class="searchField" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <th colspan="4" class="submitBtns">
            <a class="btn_submit_new modifyUsersContent"><input name="modifyUsersButton" type="button" value="保存" OnClick="modifyUsersContent(<?echo $training_id?>)"></a>
         </th>
      </tr>        
   </table>
