<?php
   ...
   $str_trainee = "select te.UserId, u.UserName, u.EmployeeId, te.RegisterDate, te.TrainingId from Trainees te left join Users u on te.UserId = u.UserId left join trainings ti on te.TrainingId = ti.TrainingId where te.Status = ti.ApproreLevel and te.TrainingId = ". $sn->Id;
