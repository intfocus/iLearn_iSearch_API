<?php
   ...
   //----- query -----
   $str_category = "select CategoryId, CategoryName, ParentId, DeptList, FilePath, PAList, ProductList, EditTime from categories where ParentId = $parentid and Status = 1 ";
   if($deptid != 0)
   {
      $str_category = $str_category . "and DeptList like '%," . $deptid . ",%';";
   }
