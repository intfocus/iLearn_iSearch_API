<?php
   require_once("Questions_utility.php");
...
function modifyUsersContent(question_id)
{
   ...
   url_str = "Questions_update_roll.php";
   $.ajax
   ({
      beforeSend: function()
      {
   ...
   <table class="searchField" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <th colspan="4" class="submitBtns">
            <a class="btn_submit_new modifyUsersContent"><input name="modifyUsersButton" type="button" value="保存" OnClick="modifyUsersContent(<?echo $question_id?>)"></a>
         </th>
      </tr>        
   </table>
