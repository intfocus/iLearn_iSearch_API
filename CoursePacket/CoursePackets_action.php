<?php
   ...
   {
      if(strcmp($check_str, "actionCoursePackets"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
   ...
   //----- query -----
   //***Step18 上下架动作修改SQL语句
   $str_query1 = "Update CoursePacket set Status=$NewStatus where CoursePacketId=$CoursePacketId";
   ...
   if(mysqli_query($link, $str_query1)){
	  $str_log = "Insert into log (UserId,FunctionName,ActionName,ActionTime,ActionReturn,ActionObject,AppName)" 
         . " VALUES('$user_id','课程包管理','课程包上下架',now(),'$ActionReturn','$CoursePacketId','pc')";
