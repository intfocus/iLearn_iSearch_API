...
(function() {
  $(function() {
    ...
    $(document).on("click", ".gridly .delete", function(event) {
      ...
      var tmp = $("input[name=CoursewareListModify]").val();
      tmp = tmp.replace(cwid,'');
      $("input[name=CoursewareListModify]").val(tmp);
    ...
    $(document).on("click", ".add", function(event) {
       var strname = "";
       var strid = "";
       var cplist = $("input[name=CoursewareListModify]").val();
       ...
       $("input[name=CoursewareListModify]").val(cplist);        
