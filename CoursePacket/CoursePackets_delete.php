<?php
   ...
   {
      if(strcmp($check_str, "deleteCoursePackets"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
   ...
   //----- query -----
   //***Step19 删除动作SQL语句
   $str_query1 = "Update CoursePacket set Status=-1 where CoursePacketId=$CoursePacketId";
   ...
   if(mysqli_query($link, $str_query1)){
	  $str_log = "Insert into log (UserId,FunctionName,ActionName,ActionTime,ActionReturn,ActionObject,AppName)" 
         . " VALUES('$user_id','课程包管理','课程包删除',now(),'课程包删除','$CoursePacketId','pc')";
