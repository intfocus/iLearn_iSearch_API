<?php
   ...
   define("CoursePacket_DELETED", -1);
   define("CoursePacket_INACTIVE", 0);
   define("CoursePacket_ACTIVE", 1);
   
   define("ERR_NOT_ENOUGH_PROBLEM", -500);
   
   define("ERR_ADJUST_LEVEL", -1000);
   
   define("CoursePacket_FILES_DIR", "./CoursePacket_files");
   define("CoursePacket_RESULT_FILES_DIR", "./Result_files");
   
   define("MSG_NOT_ENOUGH_TRUE_FALSE", "是非题数不足");
   define("MSG_NOT_ENOUGH_SEL_PROB", "单选题数不足");
   define("MSG_NOT_ENOUGH_MULTI_PROB", "多选题数不足");
   
   define("MSG_CoursePacket_MODIFY", "考卷修改");
   
   define("MOCK_CoursePacket", 0);
   define("OFFICIAL_CoursePacket", 1);
   
   define("MSG_MOCK_CoursePacket", "模拟考");
   define("MSG_OFFICIAL_CoursePacket", "正式考");
   
   define("GIVE_ANSWER_AFTER_SUBMIT", 1);
   define("GIVE_ANSWER_AFTER_CoursePacket_FINISHED", 2);

   define("MSG_GIVE_ANSWER_AFTER_SUBMIT", "考试交卷后公布答案");
   define("MSG_GIVE_ANSWER_AFTER_CoursePacket_FINISHED", "考试交卷后答案公布");
   ...
   //define("ERR_CoursePacket_NOT_EXIST", -11);
   define("ERR_CoursePacket_NOT_EXIST", -59);
   ...
   function get_CoursePacket_type_name_from_id($type)
   {
      if ($type == MOCK_CoursePacket)
      {
         return MSG_MOCK_CoursePacket;
      }
      else if ($type == OFFICIAL_CoursePacket)
      {
         return MSG_OFFICIAL_CoursePacket;
      }
   }
