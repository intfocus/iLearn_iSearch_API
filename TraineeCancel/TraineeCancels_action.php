<?php
   ...
   {
      if(strcmp($check_str, "actionTraineeCancels"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
   ...
   if($parentId == 0)
   {
      $str_query2 = "update traineecancels set Status = $approreLevel, ExamineUser = '$user_id' where  TrainingId = $TrainingId and UserId = $UserId and Status = $Status";
