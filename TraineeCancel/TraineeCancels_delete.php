<?php
   ...
   {
      if(strcmp($check_str, "deleteTraineeCancels"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
   ...
   //----- query -----
   //***Step19 删除动作SQL语句
   $str_query1 = "Update traineecancels set Status=-1 where TrainingId=$TrainingId and UserId=$UserId";
   ...
   if(mysqli_query($link, $str_query1)){
	  $str_log = "Insert into log (UserId,FunctionName,ActionName,ActionTime,ActionReturn,ActionObject,AppName)" 
         . " VALUES('$UserId','报名审核','审核驳回',now(),'$user_id','$TrainingId','pc')";
