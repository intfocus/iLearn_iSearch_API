                                    ...
                                    <div>
                                        ...
                                        <section>
                                           <table class="searchField" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                   <th>题型题数</th>
                                                   <td>是非 <input type=text class="problem_type_count" id=NewExamTrueFalseProbType size=3 value=0></td>
                                                   <td>单选 <input type=text class="problem_type_count" id=NewExamSingleSelProbType size=3 value=0></td>
                                                   <td>多选 <input type=text class="problem_type_count" id=NewExamMutiSelProbType size=3 value=0></td>
                                                </tr>
                                             </table>
                                        </section>
                                        <h3>Profile</h3>
