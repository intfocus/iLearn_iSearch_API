                      ...
                      <div class="panel-body"> 
                         <table class="searchField" border="0" cellspacing="0" cellpadding="0">
                            <form enctype="multipart/form-data" name="uploadQTForm" action="check_questiontemplate_upload.php" method="POST" enctype="multipart/form-data">
                               ...
                               <tr>
                                  <th>问卷模板名称：</th>
                                  <td><Input type="text" name="QTNameModify" size="100" value=""></td>
                               </tr>
                               <tr>
                                  <th>问卷模板说明：</th>
                                  <td><textarea name="QTDescModify" rows=3 cols=97></textarea></td>
                               </tr>
                               <tr>
                                  <th>选取上传模板：</th>
                                  <td>
                                     <Input type="file" size=50 name="fileToUpload" class="form-control" style="padding: 0;width: 630px" onchange="checkQTTypeModify();"/>
                                  </td>
                               </tr>
                               <tr>
                                  <th colspan="2" class="submitBtns">
                                     <input id="FilePath" name="modifyFilesButton" type="button" value="上传模板" onclick="modifyQTContent()" class="btn btn-purple">
                                  </th>
                               </tr>      
                            </Form>
                         </table>
