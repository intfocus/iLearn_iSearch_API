<?php
   ...
   if ($cmd == "read") // Load
   {
      $str_query1 = "Select DeptList from Categories where CategoryId=$CategoryId";
   ...
   <table class="searchField" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
         <th colspan="4" class="submitBtns">
            <a class="btn_submit_new modifyCategoriesContent"><input name="modifyCoursePacketsButton" type="button" value="保存" OnClick="modifyCategoriesContent(<?php echo $CategoryId;?>)"></a>
         </th>
      </tr>      
   </table>
</div>
