   ...
   <!-- ***Step2 搜索框的设计 开始 -->
	  ...
	  <form class="cmxform form-horizontal tasi-form searchField">
			 <div class="form-group">
				<label for="cname" class="control-label col-md-2">分类名称:</label>
				<div class="col-md-5">
					<input class="form-control" id="searchCategoriesName" type="text" maxlength="50">
				</div>
				<label for="cname" class="control-label col-md-1">状态:</label>
				<div class="col-md-2" style="padding-top:6px;">
					<label class="cr-styled">
						<input id="searchCategoriesCheckBox1" type="checkbox" checked>
						<i class="fa"></i> 
						上架
					</label>
					<label class="cr-styled">
						<input id="searchCategoriesCheckBox2" type="checkbox" checked>
						<i class="fa"></i> 
						下架
					</label>
				</div>
			...
			<div class="form-group ">
				...
				<div class="col-md-5">
					<input id="from5" type="text" style="width:46%; display:inline-block" name="searchCategoriesfrom1" class="from form-control" readonly="true"/> ~ <input id="to5" type="text" style="width:46%; display:inline-block" class="to form-control" name="searchCategoriesto1" readonly="true"/>
				</div>
			</div>
			  <div class="form-group">
				<label class="control-label col-md-2">　</label>
				<div class="col-md-5">
					<a class="btn_submit_new searchCategories"><input class="btn btn-success" name="searchCategoriesButton" type="button" value="开始查询"></a>
				</div>
			</div>
		</form>
      <!-- ***Step2 搜索框的设计 结束 -->
