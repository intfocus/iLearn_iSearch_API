<?php
   ...
   //TODO: trim space
   if (strlen($searchpptsNameDesc) > 0)
   {
      $str_query1 = $str_query1 . "AND (PPTName like '%$searchpptsNameDesc%' OR PPTDesc like '%$searchpptsNameDesc%') ";
   }
         ...
         while ($i < $row_number)
         {
            ...
            if ($page_count < $page_size)
            {
               ...
               $return_string = $return_string 
                  ...
                  . "<td><span class=\"PPTName fixWidth\">$PPTName</span></td>"
                  . "<td><span class=\"PPTDesc fixWidth\">$PPTDesc</span></td>"
                  . "<td>$StatusStr</td>"
                  . "<td>$EditTime</td>"
                  . "<td><A OnClick=\"actionSearchppts($PPTId,$Status);\">$StatusAction</A><br/>"
                  . "<A OnClick=\"modifySearchppts($PPTId);\">修改</A><br/>"
                  . "<A OnClick=\"deleteSearchppts($PPTId);\">删除</A></td>"
                  . "</tr>";
