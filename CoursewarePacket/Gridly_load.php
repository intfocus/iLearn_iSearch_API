<?php
   ...
   {
      if(strcmp($check_str, "searchcplist"))
      {
         return SYMBOL_ERROR;
      }
      return $check_str;
   ...
   if(($coursewareList = check_name($_GET["coursewareList"])) == SYMBOL_ERROR)
   {
      sleep(DELAY_SEC);
      echo SYMBOL_ERROR;
      return;
   ...
   foreach ($coursewareLists as $cl) {
       ...
       if($result = mysqli_query($link, $str_query1)){
          ...
          $return_string = $return_string + "<div class='brick small' name='" . $cl . "'>" . $row["CoursewareName"] . "<div class='delete'>&times;</div></div>";
       }
       else
       {
          if($link){
