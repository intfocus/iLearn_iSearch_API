    ...
    var O = function(h) {
        ...
        function mb(a) {
            ...
            for (var f = a.sDom.split(""), g, j, i, m, l, p, n = 0; n < f.length; n++) {
                ...
                // else if ("l" == j && e.bPaginate && e.bLengthChange) g = nb(a);//调整每页显示的行数量
                else if ("f" == j && e.bFilter) g = ob(a);//搜索框
                else if ("r" == j && e.bProcessing) g = pb(a);
                else if ("t" == j) g = qb(a);
                else if ("i" == j && e.bInfo) g = rb(a);//页数显示
                else if ("p" == j && e.bPaginate) g = sb(a);//分页
